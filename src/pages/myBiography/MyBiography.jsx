          ...
          <section className={styled.biographyWrapper}>
            <div className={styled.persian}>
              <p>
                ...
                تدریس دروس تخصصی کامپیوتر و فناوری اطلاعات در دانشگاه‌های مختلف
                . در حال حاضر در دانشگاه آزاد مشهد، دانشگاه سما، دانشگاه آزاد
                اسلامشهر و چندین مؤسسه آموزش عالی دیگر از جمله توس، اقبال
                لاهوری، بهار، فردوس، جهاد دانشگاهی، علمی‌ـ‌صنعتی خراسان فعالیت
                دارم.
              </p>
              <p>
                دارای مدرک کارشناسی ارشد فناوری اطلاعات از دانشگاه صنعتی شریف
                هستم و تمرکز اصلی من بر ترکیب آموزش آکادمیک با کاربردهای عملی
                فناوری است.
              </p>
              <p>
                همزمان با تدریس دانشگاهی، به صورت حرفه‌ای در زمینه طراحی رابط
                کاربری (UI) و توسعه فرانت‌اند وب‌سایت‌ها فعالیت دارم. تلاش
                می‌کنم با استفاده از جدیدترین تکنولوژی‌ها و استانداردها،
                تجربه‌ای مدرن و کاربرپسند برای کاربران وب ایجاد کنم.
              </p>
            </div>
            ...
            <div className={styled.english}>
              <p>
                ...
                14 years of experience in teaching specialized courses in
                Computer Science and Information Technology across various
                universities.
              </p>
              <p>
